...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2024 at 01:59 PM
...
INSERT INTO `admins_sendquery` (`id`, `sendquery`, `transid_id`, `name`, `transid`) VALUES
(1, 'dsfgd', 124, '', '100'),
(2, 'fghgfh', 364, '', '100'),
(3, 'hgfjj', 518, '', '100'),
(4, 'amount overloaded', 8, '', '100'),
(5, 'overloaded', 8, 'sabarish', '100'),
(6, '', 8, '', '100'),
(7, '', 8, '', '100'),
(8, '', 8, '', '100'),
(9, 'CHECK YOUR AMMOUNT', 518, '', '100'),
(10, 'CHECK YOUR AMMOUNT', 518, '', '100'),
(11, 'LKJLHJKL', 518, '', '100'),
(12, 'kumaran', 518, '', '100'),
(13, 'fdgdfgdfgdfgdfgdfg', 518, 'sabarish', '100'),
(14, 'venkat', 518, 'sabarish', '100'),
(15, 'amount too high,check your amount details', 519, 'lokesh', '100');
...
CREATE TABLE `alert_giventransaction` (
  `id` int(11) NOT NULL,
...
(36, 'Can view sendquery', 9, 'view_sendquery');
...
CREATE TABLE `cyber_alert_adminregister` (
  `id` int(11) NOT NULL,
...
(19, 'admin2', 'ram', 'admin@gmail.com', 'admin', '124234', 'chennai');
...
CREATE TABLE `cyber_alert_givertransaction` (
  `id` int(11) NOT NULL,
...
(24, 'admins', '0003_sendquery_transid', '2024-05-14 16:38:19'),
(25, 'auth', '0010_alter_group_name_max_length', '2024-05-14 16:38:19'),
(26, 'auth', '0011_update_proxy_permissions', '2024-05-14 16:38:19'),
(27, 'cyber_alert', '0006_givertransaction_userid', '2024-05-14 16:38:19');
...
('5ayjhfn5oe3a68notifqbwcjkopwf3ro', 'MjM5MDQ5MzFkMTNjYWZmZDNjMTMwYTMzNTkzNDk4NTMzZDczNjRlNzp7Im5hbWUiOjE5fQ==', '2024-08-25 11:05:13'),
...
('u4fg3w7wzvy6gsd69gl6k4t508q6a3lb', 'MjM5MDQ5MzFkMTNjYWZmZDNjMTMwYTMzNTkzNDk4NTMzZDczNjRlNzp7Im5hbWUiOjE5fQ==', '2024-06-03 07:25:18');
...
--
-- Indexes for table `admins_sendquery`
--
ALTER TABLE `admins_sendquery`
  ADD PRIMARY KEY (`id`),
  ADD KEY `admins_sendquery_transid_id_623c1238_fk_cyber_ale` (`transid_id`);

--
-- Indexes for table `alert_giventransaction`
--
ALTER TABLE `alert_giventransaction`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cyber_alert_adminregister`
--
ALTER TABLE `cyber_alert_adminregister`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cyber_alert_givertransaction`
--
ALTER TABLE `cyber_alert_givertransaction`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cyber_alert_givertra_userid_id_2a576597_fk_cyber_ale` (`userid_id`);
...
--
-- AUTO_INCREMENT for table `admins_sendquery`
--
ALTER TABLE `admins_sendquery`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `alert_giventransaction`
--
ALTER TABLE `alert_giventransaction`
...
--
-- AUTO_INCREMENT for table `cyber_alert_adminregister`
--
ALTER TABLE `cyber_alert_adminregister`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `cyber_alert_givertransaction`
--
ALTER TABLE `cyber_alert_givertransaction`
